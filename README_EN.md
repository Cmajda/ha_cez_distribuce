...
> 🚨 **BREAKING CHANGE v3.2.1:** Cache location changed from `custom_components/cez_hdo/data/` to `.storage/cez_hdo/`.
> After updating from version 3.2.0 or older, you need to:
> - **Wait for auto-refresh** (data will be fetched automatically via OCR within 1-2 hours), or

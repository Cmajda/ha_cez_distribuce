  ...
  function ensureEditorDefined(){
    ...
    class CezHdoCardEditor extends HTMLElement{
      ...
      _render(){
        ...
        titleField.addEventListener("input",(ev)=>{this._config={...this._config,title:ev.target.value};});
        titleField.addEventListener("change",(ev)=>{this._config={...this._config,title:ev.target.value};this._emitConfigChanged();});

...
def test_complete_workflow():
    ...
    api_response = {
        "data": {
            "signals": [
                {"signal": "a3b4dp01", "den": "Sobota", "datum": "15.11.2025", "casy": "00:00-09:31;   10:30-12:31;   13:30-18:56;   19:54-21:56;   22:55-24:00"},
                {"signal": "a3b4dp01", "den": "Neděle", "datum": "16.11.2025", "casy": "00:00-09:31;   10:30-12:31;   13:30-18:56;   19:54-21:56;   22:55-24:00"},
                {"signal": "a3b4dp01", "den": "Úterý", "datum": "18.11.2025", "casy": "00:00-05:35;   06:30-08:55;   09:54-15:16;   16:15-20:16;   21:15-24:00"},
                {"signal": "a3b4dp02", "den": "Sobota", "datum": "15.11.2025", "casy": "00:00-09:31;   10:30-12:31;   13:30-18:56;   19:54-21:56;   22:55-24:00"},
                {"signal": "a3b4dp06", "den": "Sobota", "datum": "15.11.2025", "casy": "00:35-05:50;   13:35-16:31;"},
                {"signal": "a3b4dp06", "den": "Úterý", "datum": "18.11.2025", "casy": "01:10-05:11;   11:35-13:56;   22:10-23:51;"}
            ],
            "amm": False,
            "switchClock": False,
            "unknown": False,
    ...
    (low_active, low_start, low_end, low_duration,
     high_active, high_start, high_end, high_duration) = result
    ...
    print(f"\n📝 SUMMARY:")
    print(f"✅ EAN API format: Podporován")
    print(f"✅ Multiple signals: Vybírá nejdelší rozvrh")
    print(f"✅ 24:00 time format: Správně konvertován na 00:00")
    print(f"✅ HDO logic: Funguje správně")
    print(f"✅ Weekend/weekday: Automatické rozpoznání")
    
    print(f"\n🔄 MIGRACE GUIDE:")
    print(f"PŘED: region='stred', code='a3b4dp01'")  
    print(f"PO:   ean='{ean}'")
